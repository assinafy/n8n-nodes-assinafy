...
- Package author contact accepts n8n Creator Portal ownership verification.

## [1.7.4] — 2026-09-23

### Changed

- Maintainer release instructions live in `CONTRIBUTING.md`; the user guides focus on installation and operation.

## [1.7.3] — 2026-09-23

### Changed

- GitHub releases publish to npmjs through trusted publishing with provenance.
